...
export function SocialLinkItem({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="group inline-flex w-10 h-10 items-center justify-center rounded-full bg-card text-foreground/75 ring-1 ring-border transition-colors hover:bg-primary hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
    >
      {children}
